#!/usr/bin/perl -w
# e2backup_cmd.pl - gathers user nodes from everything2.com
# from the command line

# Portions Copyright (C) 2000,2001 W. Woods 
# Portions Copyright (C) 2001,2002,2003 A. Shipkowski  
# Portions Copyright (C) 2003 J. Chatterton 
# Modified 2015 J. Parsons
...
$username = 'jurph'; # Maybe build support for ARG0 later.

#my $singleFileMode = $query->param('singleFileMode');
my $singleFileMode = 'true'; 
